---
title: Optimierung deines Leaf-Servers (1.21.4/5)
...
Nutze deren Dokumentationen (verlinkt unter [Useful Websites](../useful-sites)) und Community-Guides (z. B. Paper-chan), um diese ebenfalls zu optimieren.
