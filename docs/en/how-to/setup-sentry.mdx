---
title: How to Setup Sentry with Leaf
description: Guide for configuring Leaf to send error reports to your Sentry project for real-time error tracking and performance monitoring.
---
