...
const config: ConfigRoot = {
    ...
    async: {
        ...
        "async-playerdata-save": {
            enabled: {
                default: false,
                desc: `Whether to make player data saving asynchronous (I/O operations are expensive).<br/><br/><strong>Warning:</strong> This feature is experimental. In some edge cases, player data may not be saved correctly. Use with caution in production environments.`
            }
        },
